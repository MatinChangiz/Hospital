    ...
    <div class="icontent">
        ...
        <div class="queue_date" style="border-bottom:0.5px solid #444;margin-bottom:20px;">
            <div class="textfield btm20padding" style="padding-bottom:10px;">
                <input type="button" id="singlebutton" style="min-width:100px;" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('doctor_add')?>" onclick="bring_page('<?=base_url()?>index.php/doctors/home/add','')"> 
            </div>
        </div>  
        <div class="filterDiv">
                ...
                <table class="table table-striped table-bordered table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="prs">
                                ...
                                <td>
                                    <center><input class="btn btn-success" value="<?=$this->lang->line("edit");?>" onclick="javascript:bring_page('<?=base_url()?>index.php/doctors/home/edit/<?=$this->clean_encrypt->encode($row->urn);?>','<?=$row->urn;?>')" style="width:110px;">
                                    <input class="btn btn-danger" value="<?=$this->lang->line("delete");?>" onclick="confirm('Are you sure to delete?');javascript:bring_page('<?=base_url()?>index.php/doctors/home/delete/<?=$this->clean_encrypt->encode($row->urn);?>','<?=$row->urn;?>')" style="width:110px;margin-top:4px"></center> 
                                </td>
                            </tr>
                            <?php $i++; }} ?>
                        </tbody>
