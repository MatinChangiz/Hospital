...
<table class="table">
    ...
    <tr>
        ...
        <td scope="col" width="33%" class="iEntry">
            ...
            <div class="textfield btm20padding">
                    <input id="dr_name" name="dr_name" type="text" placeholder="<?=$this->lang->line('dr_name')?>" class="form-control iInput" value=""> 
            </div>
        </td>
    </tr>
    <tr>
...
<table class="table"> 
    ...
    <tr>
        <td scope="col" width="100%%" class="iEntry" colspan="3">
            <input type="button" id="singlebutton" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('search')?>" onclick="submitSearch('<?=base_url()?>index.php/doctors/home/filter','filter','list_div1');">                                            
