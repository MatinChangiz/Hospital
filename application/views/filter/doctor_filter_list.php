            ...
            <tbody>
                ...
                <tr class="prs">
                    ...
                    <td>
                        ...
                        <input class="btn btn-danger" value="<?=$this->lang->line("delete");?>" onclick="javascript:bring_page('<?=base_url()?>index.php/doctors/home/delete/<?=$this->clean_encrypt->encode($row->urn);?>','<?=$row->urn;?>')" style="width:110px;margin-top:4px"></center> 
                    </td>
                </tr>
                <?php $i++; }} ?>
            </tbody>
