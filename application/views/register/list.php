    ...
    <div class="icontent">
        ...
        <div class="queue_date" style="border-bottom:0.5px solid #444;margin-bottom:20px;">
            <div class="textfield btm20padding" style="padding-bottom:10px;">
                <input type="button" id="singlebutton" style="min-width:100px;" name="singlebutton" class="btn btn-success" value="<?=$this->lang->line('registeration')?>" onclick="bring_page('<?=base_url()?>index.php/register/home/add','')"> 
            </div>
        </div>  
        <div class="filterDiv">
